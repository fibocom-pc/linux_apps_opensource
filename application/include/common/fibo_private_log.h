...
#ifndef _FIBO_PRIVATE_LOG_H_
#define _FIBO_PRIVATE_LOG_H_
...
#define FIBO_LOG_CRITICAL(log, ...) g_print("[Critical]: %s:%u: "log, __FUNCTION__, __LINE__, ##__VA_ARGS__);
...
#define FIBO_LOG_DEBUG(log, ...) g_print("[Debug]: %s:%u: "log, __FUNCTION__, __LINE__, ##__VA_ARGS__);
